...
[инструкции иAWS](https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/client-authentication.html#mutual).
...
предварительно скачав конфигурацию для подключения с веб-консоли AWS в файл
